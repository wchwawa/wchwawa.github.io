...
export const copy = {
  en: {
    ...
    xContact: 'Jason on X',
    wechatContact: 'Add Jason on WeChat',
    wechatTitle: 'WeChat',
    wechatQrAlt: 'Scan this QR code in WeChat to add Jason as a friend',
    wechatOpenImage: 'Open full-size QR code',
    wechatClose: 'Close WeChat QR code',
    source: 'Site source',
  ...
  zh: {
    ...
    xContact: 'Jason 的 X',
    wechatContact: '添加 Jason 的微信',
    wechatTitle: '微信',
    wechatQrAlt: '使用微信扫描二维码，添加 Jason 为好友',
    wechatOpenImage: '打开二维码原图',
    wechatClose: '关闭微信二维码',
    source: '网站源码',
    notFound: '这里还没有这个页面。',
